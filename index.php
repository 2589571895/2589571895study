...
<div class="mdui-textfield mdui-textfield-floating-label">
  <label class="mdui-textfield-label">设备IP</label>
  <input class="mdui-textfield-input" value="<?php echo $ip; ?>" <?php echo $input; ?> type="txt" id="userip" name="userip" required/>
    </div>
<div class="mdui-textfield mdui-textfield-floating-label">
    <label class="mdui-textfield-label">服务器IP</label>
    <input class="mdui-textfield-input"  <?php echo $input; ?> type="txt" id="acip" name="acip" required/>
</div>
 <div class="mdui-textfield mdui-textfield-floating-label">
